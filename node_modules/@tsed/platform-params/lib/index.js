...
exports.DeserializerPipe = DeserializerPipe_1 = class DeserializerPipe {
...
tslib.__decorate([di.Constant("converter", {}), tslib.__metadata("design:type", Object)], exports.DeserializerPipe.prototype, "settings", void 0);

exports.DeserializerPipe = DeserializerPipe_1 = tslib.__decorate([di.Injectable()], exports.DeserializerPipe);
...
exports.PlatformParams = class PlatformParams {
  ...
  async compile(entity) {
    const params = exports.ParamMetadata.getParams(entity.target, entity.propertyKey);
  ...
  async compileHandler(metadata) {
    ...
    const getArguments = getCustomArgs || (await this.compile(schema.JsonEntityStore.fromMethod(token, propertyKey)));

    if (!provider || !provider.scope || provider.scope === di.ProviderScope.SINGLETON) {
