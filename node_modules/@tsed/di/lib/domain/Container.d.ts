...
export declare class Container extends LocalsContainer<Provider> {
    /**
     *
     * @param token
     * @param settings
     */
    add(token: TokenProvider, settings?: Partial<IProvider>): this;
    /**
     * Add a provider to the
     * @param token
     * @param settings
     */
    addProvider(token: TokenProvider, settings?: Partial<IProvider>): this;
    /**
     *
     * @param token
     */
     ...
     * @param token
     */
    getProvider(token: TokenProvider): Provider | undefined;
    /**
