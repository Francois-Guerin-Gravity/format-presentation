...
export declare type HeaderValue = Array<boolean | number | string> | boolean | number | string;
/**
 * Platform Response abstraction layer.
 * @platform
 */
export declare class PlatformResponse<T extends Record<string, any> = any> {
