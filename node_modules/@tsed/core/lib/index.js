...
exports.AnyToPromiseStatus = void 0;
...
})(exports.AnyToPromiseStatus || (exports.AnyToPromiseStatus = {}));

exports.AnyToPromiseResponseTypes = void 0;
...
})(exports.AnyToPromiseResponseTypes || (exports.AnyToPromiseResponseTypes = {}));

var _resolves = /*#__PURE__*/_classPrivateFieldLooseKey("resolves");

var _rejects = /*#__PURE__*/_classPrivateFieldLooseKey("rejects");

var _hasNextFunction = /*#__PURE__*/_classPrivateFieldLooseKey("hasNextFunction");
...
class AnyToPromise {
  constructor({
    ...
    Object.defineProperty(this, _hasNextFunction, {
      writable: true,
      value: void 0
    });
    ...
    this.status = exports.AnyToPromiseStatus.PENDING;
    _classPrivateFieldLooseBase(this, _hasNextFunction)[_hasNextFunction] = false;
    _classPrivateFieldLooseBase(this, _hasNextFunction)[_hasNextFunction] = hasNextFunction;
  ...
  isDone() {
    return this.status !== exports.AnyToPromiseStatus.PENDING;
  }

  get next() {
    _classPrivateFieldLooseBase(this, _hasNextFunction)[_hasNextFunction] = true;
    return error => {
      if (this.isDone()) {
        return;
      }
      ...
      return error ? this.reject(error) : this.resolve({
        type: exports.AnyToPromiseResponseTypes.DATA
      });
    };
  }
  /**
  ...
  reject(er) {
    ...
    this.done(exports.AnyToPromiseStatus.REJECTED);
  ...
  resolve(response = {}) {
    ...
    this.done(exports.AnyToPromiseStatus.RESOLVED);

    _classPrivateFieldLooseBase(this, _resolves)[_resolves](_extends({}, response, {
      state: exports.AnyToPromiseStatus.RESOLVED
    }));
  }
  ...
  cancel() {
    ...
    this.done(exports.AnyToPromiseStatus.CANCELED);
    return _classPrivateFieldLooseBase(this, _resolves)[_resolves]({
      state: exports.AnyToPromiseStatus.CANCELED
    });
  }
  ...
  handle(process, additionalProps = {}) {
    ...
    if (process) {
      ...
      if (isResponse(process)) {
        return this.handle(process.data, _extends({}, additionalProps, {
      ...
      if (isStream(process)) {
        return this.resolve(_extends({}, additionalProps, {
          type: exports.AnyToPromiseResponseTypes.STREAM,
          data: process
        }));
      }
      ...
      if (isStream(process) || Buffer.isBuffer(process)) {
        return this.resolve(_extends({}, additionalProps, {
          type: exports.AnyToPromiseResponseTypes.BUFFER,
          data: process
        }));
      }

      if (isPromise(process)) {
        return process.then(result => this.handle(result, additionalProps)).catch(error => {
    ...
    if (!_classPrivateFieldLooseBase(this, _hasNextFunction)[_hasNextFunction]) {
  ...
  isCanceledResponse(process) {
    return process === exports.AnyToPromiseStatus.CANCELED;
  }
