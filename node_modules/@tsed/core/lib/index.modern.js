...
class AnyToPromise {
  ...
  resolve(response = {}) {
    ...
    _classPrivateFieldLooseBase(this, _resolves)[_resolves](_extends({}, response, {
      state: AnyToPromiseStatus.RESOLVED
    }));
  }
  ...
  cancel() {
    ...
    return _classPrivateFieldLooseBase(this, _resolves)[_resolves]({
      state: AnyToPromiseStatus.CANCELED
    });
  }
    ...
    if (process) {
      ...
      if (isStream(process)) {
        return this.resolve(_extends({}, additionalProps, {
          type: AnyToPromiseResponseTypes.STREAM,
          data: process
        }));
      }
      ...
      if (isStream(process) || Buffer.isBuffer(process)) {
        return this.resolve(_extends({}, additionalProps, {
          type: AnyToPromiseResponseTypes.BUFFER,
          data: process
        }));
      }
